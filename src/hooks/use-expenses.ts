 ...
 *
 * SECURITY: Explicitly filters by businessId or user_id.
 * RLS policies: "Users can view their own expenses" — (auth.uid() = user_id OR is_business_member(auth.uid(), business_id))
 */
