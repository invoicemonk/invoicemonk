 ...
 * RLS policies: "Users can view their clients" — (auth.uid() = user_id OR is_business_member(auth.uid(), business_id))
 */
 ...
 * Note: Clients can have business_id = null (user-level clients), which is allowed.
 */
