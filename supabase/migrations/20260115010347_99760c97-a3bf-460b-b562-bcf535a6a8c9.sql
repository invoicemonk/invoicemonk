-- Fix the existing draft invoice - set business_id and clear user_id (constraint requires one or the other)
UPDATE invoices 
SET business_id = 'b42ad810-58cb-4ab5-a1ec-3912f830db31',
    user_id = NULL
WHERE id = '55cc58ca-55d6-401d-903f-012041e4b83a' 
  AND status = 'draft';

-- Improve issue_invoice function with better error messages
