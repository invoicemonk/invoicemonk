-- Add cac_number column to businesses table for Nigerian companies (and similar registration numbers for other jurisdictions)
ALTER TABLE public.businesses 
ADD COLUMN IF NOT EXISTS cac_number TEXT;

-- Add comment explaining the purpose
COMMENT ON COLUMN public.businesses.cac_number IS 'Corporate registration number (CAC for Nigeria, Companies House for UK, etc.)';

-- Update the issue_invoice function to include cac_number in snapshots and additional client fields
...
BEGIN
  ...
  UPDATE invoices SET
    ...
    -- Updated issuer_snapshot to include cac_number
    ...
    -- Updated recipient_snapshot to include cac_number, client_type, contact_person
