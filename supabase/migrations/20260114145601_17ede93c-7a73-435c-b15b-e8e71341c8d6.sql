-- Fix 1: Update issue_invoice to use correct parameter order for check_tier_limit
-- AND add tax_id to compliance check
...
BEGIN
  ...
  -- Check tier limits - FIXED: correct parameter order (_user_id, _feature)
...
-- Fix 2: Update compute_business_compliance to include tax_id check
...
-- Recompute compliance for all existing businesses
