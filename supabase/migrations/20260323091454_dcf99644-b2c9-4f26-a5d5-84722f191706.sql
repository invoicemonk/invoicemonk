...
CREATE OR REPLACE FUNCTION get_receivables_intelligence(
  _business_id UUID,
...
BEGIN
  ...
  -- Total outstanding (issued, viewed, or overdue invoices with unpaid balance)
  ...
  -- Slow payers (top 5 clients by avg days to pay)
